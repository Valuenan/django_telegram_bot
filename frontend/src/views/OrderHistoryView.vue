                    ...
                    <div class="tab-bar-screen_screen__y4lze tab-bar-screen_active__pBXjN tab-cart">
                        <div class="stack-navigation_screen___5WKf screen-0">
                            <div class="cart-screen_cart_screen__y134H">
                                <div class="header_header__HtwnO" style="padding:10px">
                                    <button @click="fetchOrders(prevPageUrl)"
                                ...
                                <div class="cart-screen_wrapper__LWL3f">
                                    <div class="cart-screen_cart__JV4JN">
                                            ...
                                            <div class="cart-item_body__1FLl_">
                                                ...
                                                <div class="cart-item_body__1FLl_ info-item__MUAX2">
                                                    <a :href="order.payment_url" v-if="!order.extra_payment_url">
                                                        ...
                                                        <span v-else-if="order.payment_url === null">Проверяем наличие товаров, ожидайте ссылку на оплату</span>
                                                        <span v-else>Ссылка на оплату</span>
                                                    </a>
                                                    <a :href="order.extra_payment_url" v-else> <span v-if="order.payed">Чек:</span>
                                                        <span v-if="order.payed">Чек</span>
                                                        <span v-else-if="order.extra_payment_url === null">Проверяем наличие товаров, ожидайте ссылку на оплату</span>
                                                        <span v-else>Ссылка на оплату</span>
                                                    </a>
                                                </div>
                                            ...
                                            <div v-for="cart in order.carts" :key="cart.id"
                                                ...
                                                <div class="cart-item_body__1FLl_">
                                                    <div class="cart-item_name_and_checkbox__IL5UT">
                                                        <div class="cart-item_name__9l_04">{{ cart.product.name }}
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <div><span>Артикул: {{ cart.product.id }}</span></div>
                                                    </div>

                                                    <div class="cart-item_price__HIS5_">
                                                        <span>Цена: {{ cart.total_discounted_price }}&nbsp;₽</span>
                                                    </div>
                                                    <div class="cart-item_actions__OE4gV">
                                                        <div class="cart-item_button__MUAX2">
                                                            {{ cart.amount }} шт. X {{ cart.discounted_price }}&nbsp;₽
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div v-else class="cart-screen_empty__mDtgG"> <!-- если пусто -->
                                            ...
                                            <div class="cart-screen_text__iXE2X">Пока тут пусто. Здесь появятся ваши
                                                заказы.
                                            </div>
                                        </div>
                                    </div>
